...
function start(current)
{
  ...
  console.log("Type ".red + "DROP".blue + " and the ".red + "INITIAL ".blue +
    "to drop object.".red);
  console.log(
    "Your steps are being counted. Try to finish with the fewest number of moves."
    .red);
...
function askDifficulty()
{
  ...
  console.log(
    "Would you like to play the easy version, the hard version, or the random version of this game ? (E/D/R) \n" +
    "Easy:".red + " the danger is confined to one room. (E) \n" +
    "Difficult:".red + " the danger is randomized. (D) \n" + "Random:".red +
    " objects AND dangers are randomized. (R)");
  ...
  function setDifficulty(err, decision)
  {
    ...
    {
      console.log("Please enter" + " E ".red + "or" + " D".red + "or" +
        " R".red + ".");
      askDifficulty();
    }
  }
...
function currentRoom(current)
{
  ...
  console.log("");
  console.log("You are in the " + (rooms[current].name).blue + (rooms[current]
    .description));
  objectKey(current);
}
...
function objectSword(current)
{
  if (rooms[current].SW === true)
  {
    ...
    function weaponPickUp(err, pickUp)
    {
      ...
      {
        console.log(
          "You cannot pick up two weapons at the time. Please drop gun to pick up sword."
          .red)
        currentRoom(current);
      }
      else if (pickUp === "N")
...
function input(current)
{
  ...
  function checkIfLocked(err, direction)
  {
    ...
    {
      console.log("That door is locked. I wonder if there is a".red +
        " key ".magenta + "somewhere in here.".red);
      currentRoom(current);
    }
    else
    {
